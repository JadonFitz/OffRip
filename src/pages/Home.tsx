        ...
        <div className="team-inner">
          ...
          <div className="team-grid">
            {[
              ...
              { initials: "TM", name: "Tony Montrone",       role: "Ethan",                     bg: "linear-gradient(135deg, #2d5f6e, #5c2e15)", photo: "/images/cast/tony-montrone.jpg" },
              { initials: "JT", name: "Jack Tenney",         role: "Himself",                   bg: "linear-gradient(135deg, #d49050, #1a3d4a)", photo: "/images/cast/jack-tenney.jpg" },
              { initials: "SM", name: "Sterling Myers",      role: "Stunt Double · Jadon Cal",  bg: "linear-gradient(135deg, #5a8a98, #0a0907)", photo: "/images/cast/sterling-myers.jpg" },
